...
- [`x_bind()`](https://teebusch.github.io/sherpa/reference/x_bind.md) :
  Attribute Binding
- [`x_change()`](https://teebusch.github.io/sherpa/reference/x_change.md)
  : Change Event Shortcut
- [`x_click()`](https://teebusch.github.io/sherpa/reference/x_click.md)
...
- [`x_for()`](https://teebusch.github.io/sherpa/reference/x_for.md) :
  Loop Through Data (x-for)
- [`x_html()`](https://teebusch.github.io/sherpa/reference/x_html.md) :
  Bind HTML Content
- [`x_id()`](https://teebusch.github.io/sherpa/reference/x_id.md) :
  Generate Unique IDs
- [`x_if()`](https://teebusch.github.io/sherpa/reference/x_if.md) :
  Conditional Rendering (x-if)
- [`x_ignore()`](https://teebusch.github.io/sherpa/reference/x_ignore.md)
...
- [`x_text()`](https://teebusch.github.io/sherpa/reference/x_text.md) :
  Bind Text Content
